...
class WelcomePage():
    def __init__(self, master):
        ...
        ttk.Style().configure("TButton", padding=6, relief="groove", background="#dadae3", padx=2, pady=2, height=5,
                              width=20, foreground='#000000', highlightthickness='20', font=('Helvetica', 12, 'bold'))
...
class PCA_graph(ttk.Frame):
    def __init__(self, master):
        ...
        fig = Figure(figsize=(10, 10), dpi=100)
        ax = fig.add_subplot(1, 1, 1, axisbg='#cccccc')
        demo_port = ['SPY', 'BA', 'WFC', 'PEP', 'AMGN', 'BAX', 'BK', 'FB', 'COST', 'DIS', 'LOW', 'FDX', 'TWX', 'AIG',
                     'MSFT', 'IBM', 'SBUX', 'FCX', 'PG', 'BMY', 'MDT', 'SPG', 'VZ', 'OXY', 'CL', 'GILD', 'CVS', 'AMZN',
                     'GE', 'ABT', 'JNJ', 'UTX', 'WMT', 'ALL', 'PFE', 'FOXA', 'MO', 'MCD', 'MMM', 'SO', 'MON', 'APC',
                     'NOV', 'APA', 'CMCSA', 'DVN', 'ACN', 'CAT', 'EXC', 'TXN', 'UNP', 'HPQ', 'V', 'LMT', 'RTN', 'CSCO',
                     'DOW', 'LLY', 'NSC', 'JPM', 'C', 'HAL', 'INTC', 'ABBV', 'UNH', 'MA', 'GM', 'XOM', 'KO', 'EBAY',
                     'MET', 'GS', 'CVX', 'HON', 'MRK', 'AXP', 'USB', 'EMC', 'DD', 'HD', 'AAPL', 'PM', 'F', 'T', 'UPS',
                     'SLB', 'AEP', 'EMR', 'COF', 'MDLZ', 'GOOG', 'NKE', 'COP', 'QCOM', 'TGT', 'ORCL', 'GD', 'MS', 'BAC']
...
def demo():
    demo_port = ['SPY', 'BA', 'WFC', 'PEP', 'AMGN', 'BAX', 'BK', 'FB', 'COST', 'DIS', 'LOW', 'FDX', 'TWX', 'AIG',
                 'MSFT', 'IBM', 'SBUX', 'FCX', 'PG', 'BMY', 'MDT', 'SPG', 'VZ', 'OXY', 'CL', 'GILD', 'CVS', 'AMZN',
                 'GE', 'ABT', 'JNJ', 'UTX', 'WMT', 'ALL', 'PFE', 'FOXA', 'MO', 'MCD', 'MMM', 'SO', 'MON', 'APC', 'NOV',
                 'APA', 'CMCSA', 'DVN', 'ACN', 'CAT', 'EXC', 'TXN', 'UNP', 'HPQ', 'V', 'LMT', 'RTN', 'CSCO', 'DOW',
                 'LLY', 'NSC', 'JPM', 'C', 'HAL', 'INTC', 'ABBV', 'UNH', 'MA', 'GM', 'XOM', 'KO', 'EBAY', 'MET', 'GS',
                 'CVX', 'HON', 'MRK', 'AXP', 'USB', 'EMC', 'DD', 'HD', 'AAPL', 'PM', 'F', 'T', 'UPS', 'SLB', 'AEP',
                 'EMR', 'COF', 'MDLZ', 'GOOG', 'NKE', 'COP', 'QCOM', 'TGT', 'ORCL', 'GD', 'MS', 'BAC']
